...
export function homePage() {
  ...
  <section class="hero">
    <div class="wrap">
      <img src="/public/logo.png" alt="WARCHEST NSW" class="hero-logo">
      <h1>WARCHEST <span style="color:var(--gold)">NSW</span></h1>
      <div class="nsw-rule"><span></span>Earn Your Place · Fight For The Chest<span></span></div>
      <p class="lede">The honest home of NSW combat sports. Every record is real, every fighter is on show, and <strong>every fight is agreed by both fighters</strong> before it's made. No mismatches. No padded records. No matchmaker games. Just clean, fair fights.</p>
      <div class="hero-ctas">
  ...
  <section class="section">
    <div class="wrap">
      <h2 style="text-align:center">Combat sports, without the sly stuff</h2>
      <div class="divider-gold"></div>
      <p style="text-align:center;color:var(--grey);max-width:720px;margin:0 auto 10px">The old way lets promoters and matchmakers lie about records and force mismatches to protect their fighters. We built the opposite. On WARCHEST everything is out in the open, and a fight only happens when both fighters look at each other's real record and say yes.</p>
      <div class="feature-grid">
        <div class="card">
          <div class="icon">🔍</div>
          <h3>Real Records, On Show</h3>
          <p>Every fighter's wins, losses, draws and KO count are public. No hiding a record, no inflating one. What you see is what they've done.</p>
        </div>
        <div class="card">
          <div class="icon">🤝</div>
          <h3>Both Fighters Agree</h3>
          <p>A fight is only made when we match two profiles and <em>both fighters accept</em>. Nobody gets fed a mismatch they didn't sign up for.</p>
        </div>
        <div class="card">
          <div class="icon">⚖️</div>
          <h3>Fair by Weight &amp; Level</h3>
          <p>Amateur and pro divisions kept separate, matched on the right weight. The platform makes lopsided fights obvious to everyone.</p>
        </div>
        <div class="card">
          <div class="icon">🥊</div>
          <h3>Fight on Our Cards</h3>
          <p>Nominate for our fight nights, get matched fair, and step onto a WARCHEST card that fans and scouts can see.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="background:linear-gradient(180deg,#0d0d0d,#0a0a0a);border-top:1px solid var(--line);border-bottom:1px solid var(--line)">
    <div class="wrap">
      ...
      <div class="steps-grid">
        ...
        <div class="step-card"><span class="step-num">4</span><h3>Step on the card</h3><p>The confirmed bout goes on a WARCHEST fight night for everyone to see. Clean fight, made right.</p></div>
      </div>
...
export function fighterProfilePage({ fighter, weightDivision, bio, isOwner, admin = false, bouts = [] }) {
    ...
    <div class="wrap">
      ...
      <div class="profile-head">
        ...
        <div>
          ...
          <div style="margin-bottom:10px">${availabilityBadge(fighter.availability)}</div>
    ...
    <div class="wrap">
      ...
      <div class="hub-grid">
        ...
        <a class="hub-tab" href="/events">
          ...
          <p>See scheduled fight nights, the confirmed card, and nominate yourself to fight.</p>
      ...
      <div class="card form-card">
        ...
        <form method="POST" action="/events" enctype="multipart/form-data">
          <div class="field">
            ...
            <input type="text" id="title" name="title" value="${escapeHtml(values.title || "")}" placeholder="e.g. WARCHEST 01" required>
          </div>
          <div class="field">
