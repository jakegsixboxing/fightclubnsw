...
export function homePage() {
  ...
  <section class="hero">
    <div class="wrap">
      ...
      <div class="nsw-rule"><span></span>The Honest Home of NSW Boxing<span></span></div>
      <p class="lede">A transparent platform where every record is real, every fighter is on show, and <strong>every fight is agreed by both boxers</strong> before it's made. No mismatches. No padded records. No matchmaker games. Just clean, fair fights.</p>
      <div class="hero-ctas">
    ...
    <div class="wrap">
      ...
      <div class="feature-grid">
        ...
        <div class="card">
          ...
          <p>A fight is only made when we match two profiles and <em>both boxers accept</em>. Nobody gets fed a mismatch they didn't sign up for.</p>
        </div>
        <div class="card">
        ...
        <div class="card">
          ...
          <p>Nominate for our fight nights, get matched fair, and step onto a Fight Club NSW card that fans and scouts can see.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section" style="background:linear-gradient(180deg,#0d0d0d,#0a0a0a);border-top:1px solid var(--line);border-bottom:1px solid var(--line)">
    <div class="wrap">
      ...
      <div class="steps-grid">
        ...
        <div class="step-card"><span class="step-num">4</span><h3>Step on the card</h3><p>The confirmed bout goes on a Fight Club NSW fight night for everyone to see. Clean fight, made right.</p></div>
      </div>
