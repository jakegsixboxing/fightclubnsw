...
export function homePage() {
  ...
  <section class="hero">
    <div class="wrap">
      ...
      <p class="lede">The honest home of NSW boxing. Every record is real, every boxer is on show, and <strong>every fight is agreed by both boxers</strong> before it's made. No mismatches. No padded records. No matchmaker games. Just clean, fair fights.</p>
      <div class="hero-ctas">
  ...
  <section class="section">
    <div class="wrap">
      ...
      <p style="text-align:center;color:var(--grey);max-width:720px;margin:0 auto 10px">The old way lets promoters and matchmakers lie about records and force mismatches to protect their fighters. We built the opposite. At Prize Fighter NSW everything is out in the open, and a fight only happens when both boxers look at each other's real record and say yes.</p>
