...
export function layout({ title, user, body, active }) {
  const nav = [
    { href: "/fighters", label: "Fighter Roster", key: "roster" },
  ];
...
<title>${escapeHtml(title)} | Fight Club NSW</title>
...
<meta name="apple-mobile-web-app-title" content="FC NSW">
...
<header class="site-header">
  <div class="wrap header-inner">
    <a class="brand" href="/">
      <img src="/public/logo.png" alt="Fight Club NSW" class="brand-logo">
      <span class="brand-text">FIGHT CLUB <span class="brand-nsw">NSW</span></span>
    </a>
    <nav class="main-nav">
      ${nav
        .map(
...
<footer class="site-footer">
  <div class="wrap">
    <img src="/public/logo.png" alt="Fight Club NSW" class="footer-logo">
    <p>Fight Club NSW &mdash; register your interest for our fight nights.</p>
  </div>
</footer>
