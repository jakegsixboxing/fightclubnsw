...
export function layout({ title, user, body, active }) {
  const nav = user
    ? [
        { href: "/fighters", label: "Fighters", key: "roster" },
        { href: "/events", label: "Nominations", key: "events" },
        { href: "/confirmed", label: "Confirmed", key: "confirmed" },
        { href: "/points", label: "Points", key: "points" },
      ]
    : [];
...
<title>${escapeHtml(title)} | Prize Fighter NSW</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700;800;900&family=Oswald:wght@500;600;700&family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
...
<meta name="apple-mobile-web-app-title" content="Prize Fighter">
...
<header class="site-header">
  <div class="wrap header-inner">
    <a class="brand" href="/">
      <img src="/public/logo.png" alt="Prize Fighter NSW" class="brand-logo">
      <span class="brand-text">PRIZE FIGHTER <span class="brand-nsw">NSW</span></span>
    </a>
    <nav class="main-nav">
      ${nav
        .map(
...
<footer class="site-footer">
  <div class="wrap">
    <img src="/public/logo.png" alt="Prize Fighter NSW" class="footer-logo">
    <p>Prize Fighter NSW &mdash; honest NSW boxing. Real records, fair fights.</p>
  </div>
</footer>
